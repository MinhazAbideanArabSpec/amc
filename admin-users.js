...
async function viewAsCustomer(customerId) {
  ...
  document.getElementById('customer-sidebar').style.display = 'flex';
  document.getElementById('admin-refresh-btn').style.display = 'none';
  document.getElementById('topbar-bell').style.display = 'flex';
  const custNameEl = document.getElementById('who-name-customer');
  if (custNameEl) custNameEl.textContent = profile.name;
  const topbarTitle = document.getElementById('app-topbar-title');
  if (topbarTitle) topbarTitle.textContent = profile.name;
  if (typeof _adminTabLoaded !== 'undefined') _adminTabLoaded = {};
  if (typeof _adminTabLoaded !== 'undefined') _adminTabLoaded = {};
...
function exitViewAs() {
  ...
  const topbarTitle = document.getElementById('app-topbar-title');
  if (topbarTitle) topbarTitle.textContent = 'Clients';
  if (typeof _adminTabLoaded !== 'undefined') _adminTabLoaded = {};
