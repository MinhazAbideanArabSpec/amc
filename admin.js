...
async function viewAsCustomer(customerId) {
  ...
  // Clear all cached data from previous customer
  customerAssetsCache = [];
  ...
  // Clear all dashboard UI elements to empty state
  const clearIds = [
    ...
    'istat-contract-days','istat-assets','istat-visits','istat-notif-count'
  ];
  clearIds.forEach(id => {
  ...
  if (istatNotifSub) istatNotifSub.textContent = '';
