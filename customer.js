// customer.js — customer dashboard, statuses, visit scores, visit dates
  ...
  async function loadVisitDashboard(customerId) {
    ...
    const SECTION_NAMES = CHECKLIST.map(s => s.section);
    const sectionTotals = {}; // { sectionName: { pass, ok, fail, total } }
  ...
  //  STATUS — Admin
  // ═══════════════════════════════════════════════════════
  let selectedStatusColor = 'slate';
  let selectedStatusIcon = null;
  let allStatusDefs = [];
