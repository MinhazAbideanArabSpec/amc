  ...
  container.innerHTML = reports.map(r => `
    <div class="report-list-item">
      ...
      <div style="display:flex;gap:8px;">
        ...
        <button style="padding:6px 14px;font-size:12.5px;display:flex;align-items:center;gap:5px;" onclick="downloadVisitReportPDF('${r.id}','${r.visit_number.replace(/'/g,"\\'")}','${fmtDate(r.visit_date)}','${r.engineer_name.replace(/'/g,"\\'")}',this)">
