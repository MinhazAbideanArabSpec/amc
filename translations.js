...
var TRANSLATIONS = {
  en: {
    ...
    tab_reports: 'Visit Reports',
    // Stat cards
    stat_days_remaining: 'Days Remaining', stat_total_assets: 'Total Assets',
    stat_active_statuses: 'Active Statuses', stat_visit_reports: 'Visit Reports',
  ...
  ar: {
    ...
    tab_reports: 'تقارير الزيارات',
    // Stat cards
    stat_days_remaining: 'الأيام المتبقية', stat_total_assets: 'إجمالي الأصول',
    stat_active_statuses: 'الحالات النشطة', stat_visit_reports: 'تقارير الزيارات',
...
function applyTranslations() {
  ...
  if (dateEl) {
    ...
    dateEl.innerHTML = `
      ...
      <span style="opacity:0.8;">${hijriStr}</span>
    `;
  }
