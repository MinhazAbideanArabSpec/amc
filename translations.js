...
var TRANSLATIONS = {
  en: {
    ...
    contract_start_date: 'Start Date', contract_end_date: 'End Date',
  ...
  ar: {
    ...
    contract_start_date: 'تاريخ البدء', contract_end_date: 'تاريخ الانتهاء',
...
function applyTranslations() {
  ...
  if (myProfile?.id) {
    ...
    if (typeof loadCustomerContracts === 'function') loadCustomerContracts(getCustomerId());
