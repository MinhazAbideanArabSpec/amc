...
var TRANSLATIONS = {
  en: {
    ...
    tab_contracts: 'My Contracts', tab_assets: 'Assets', tab_dc: 'Data Center', tab_contract: 'Contract',
    tab_reports: 'Visit Reports', tab_subs: 'Subscriptions', btn_view_all: 'View All',
    // Stat cards
    stat_days_remaining: 'Contract Days Remaining', stat_total_assets: 'Total Assets',
  ...
  ar: {
    ...
    tab_contracts: 'عقودي', tab_assets: 'الأصول', tab_dc: 'مركز البيانات', tab_contract: 'العقد',
    tab_reports: 'تقارير الزيارات', tab_subs: 'الاشتراكات', btn_view_all: 'عرض الكل',
    // Stat cards
    stat_days_remaining: 'أيام العقد المتبقية', stat_total_assets: 'إجمالي الأصول',
