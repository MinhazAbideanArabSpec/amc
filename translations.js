...
var TRANSLATIONS = {
  en: {
    ...
    tab_reports: 'Visit Reports', tab_subs: 'Subscriptions',
    ...
    card_asset_statuses: 'Asset Statuses',
  ...
  ar: {
    ...
    tab_reports: 'تقارير الزيارات', tab_subs: 'الاشتراكات',
    ...
    card_asset_statuses: 'حالات الأصول',
...
function applyTranslations() {
  ...
  if (myProfile?.id) {
    ...
    if (typeof loadVisitDates === 'function') loadVisitDates(myProfile.id, myProfile.next_visit_date);
    // Re-render customer statuses
    if (typeof loadCustomerStatuses === 'function') loadCustomerStatuses(myProfile.id);
    // Re-render customer assets
    if (typeof loadCustomerAssets === 'function') loadCustomerAssets(myProfile.id);
    // Re-render subscriptions dashboard tile
    if (typeof loadCustomerSubscriptions === 'function') loadCustomerSubscriptions(myProfile.id);
  }
}
