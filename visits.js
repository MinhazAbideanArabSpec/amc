...
function renderChecklistForm(assets) {
  ...
  container.innerHTML = assets.map(a => `
    <div class="report-asset-block" style="margin-top:6px;">
      ...
      ${FIXED_STATUSES.length ? `
        <div class="report-section-block" style="background:#FAFAF9;">
          <div class="report-section-title" style="margin-bottom:12px;">
            Asset Status
            <span style="font-size:10px;font-weight:400;color:#8A8377;margin-left:6px;">Select the overall status for this asset</span>
          </div>
            ...
            return `
              <div style="margin-bottom:10px;">
                <label style="display:flex;align-items:center;gap:8px;cursor:pointer;">
                  ...
                  <span style="width:9px;height:9px;border-radius:50%;background:${st.hex};display:inline-block;flex-shrink:0;"></span>
                  <span style="font-size:13px;font-weight:600;color:${st.hex};">${st.name}</span>
                </label>
